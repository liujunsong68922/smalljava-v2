...
import com.smalljava.l5_expression.analyse.plugin.atom.AtomOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.constvalue.ConstNumberOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.constvalue.ConstStringOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.obj.ObjectCallOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.one.LogicNotOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.two.LogicCompareOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.two.LogicComputeOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.two.MathAddDeaddOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.two.MathMultiDevideOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.var.NewObjectOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.var.VarSetOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.var.VariableDefineOperPlugin;
import com.smalljava.l5_expression.analyse.plugin.var.VariableOperPlugin;
